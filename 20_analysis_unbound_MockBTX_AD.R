...
# INPUT:
# "search_results\\Unbound_MockBTX_AD\\combined\\txt\\proteinGroups.txt"

# OUTPUT:
# "plots\\MockBTX_AD_log2_raw_intensities.pdf"
# "plots\\ProteinGroups_MockBTX_AD_Volcano_pmod_log2FC.pdf"
# "plots\\MockBTX_AD_selected_proteins.pdf"
# "SupplData02_Proteingroups_Intensities_MockBTX_AD.txt"
# "Figures\\SupplFig_4ABC\\ProteinGroups_MockBTX_AD.txt"

local({

  if(!dir.exists("Figures\\SupplFig_4ABC")) dir.create("Figures\\SupplFig_4ABC", recursive = TRUE)
  ...
  pg <- fread("search_results\\Unbound_MockBTX_AD\\combined\\txt\\proteinGroups.txt", check.names = TRUE)
  ...
  int_cols <- c("Mock_01", "BTX_01", "Mock_02", "BTX_02", "Mock_03", "BTX_03")
  names(temp) <- c("id", "n.zero", int_cols)

  pdf("plots\\MockBTX_AD_log2_raw_intensities.pdf")
  boxplot(log2(temp[, c("Mock_01", "Mock_02", "Mock_03", "BTX_01", "BTX_02", "BTX_03")]))
  dev.off()
  ...
  tr <- c("Mock", "BTX", "Mock", "BTX", "Mock", "BTX")
  ...
  pdf("plots\\ProteinGroups_MockBTX_AD_Volcano_pmod_log2FC.pdf")
  ...
  pdf("plots\\MockBTX_AD_selected_proteins.pdf", width = 6, height = 4)
  ...
  fwrite(df_sub, "SupplData02_Proteingroups_Intensities_MockBTX_AD.txt", sep = "\t")
  
  # provide figure source data
  fwrite(df_sub, "Figures\\SupplFig_4ABC\\ProteinGroups_MockBTX_AD.txt", sep = "\t")
