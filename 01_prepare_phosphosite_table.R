...
# output:
# "temp\\Protein_site.tsv"          phosphorylation site - protein annotation          
# "temp\\Protein_site_compact.tsv"  protein - phosphorylation site annotation
# "tempPhosphosites_prepared.tsv"       accordingly modified "Phosphosites (STY).txt" table
...
local({
  ...
  # save tables in temp folder
  fwrite(df_prot_single, "temp\\Protein_site_compact.tsv", sep = "\t")
  fwrite(df_prot, "temp\\Protein_site.tsv", sep = "\t")
