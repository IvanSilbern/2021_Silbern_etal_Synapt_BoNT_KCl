...
local({
  ...
  if(!dir.exists("Figures\\Fig_4D\\")) dir.create("Figures\\Fig_4D\\", recursive = TRUE)
  ...
  # provide figure data
  fwrite(path_long, "Figures\\Fig_4D\\reactome_count.txt", sep = "\t")
  fwrite(df_tests, "Figures\\Fig_4D\\reactome_pvalue.txt", sep = "\t")
