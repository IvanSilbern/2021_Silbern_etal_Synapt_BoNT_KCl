...
# "Figures\\SupplFig_15\\Proteingroup_Intensity_Suprenatants_Cbotulinum.txt"


local({

  if(!dir.exists("Figures\\SupplFig_15\\")) dir.create("Figures\\SupplFig_15\\", recursive = TRUE)
  ...
  # provide source data
  fwrite(df_long, "Figures\\SupplFig_15\\Proteingroup_Intensity_Suprenatants_Cbotulinum.txt", sep = "\t")
