...
# INPUT:
# "search_results\\Unbound_MockBTX_CB\\combined\\txt\\proteinGroups.txt"

# OUTPUT:
# "plots\\MockBTX_CB_log2_raw_intensities.pdf"
# "plots\\ProteinGroups_MockBTX_CB_Volcano_pmod_log2FC.pdf"
# "plots\\MockBTX_CB_selected_proteins.pdf"
# "SupplData02_Proteingroups_Intensities_MockBTX_CB.txt"
# "Figures\\SupplFig_4DEF\\ProteinGroups_MockBTX_CB.txt"

local({
  
  if(!dir.exists("Figures\\SupplFig_4DEF")) dir.create("Figures\\SupplFig_4DEF", recursive = TRUE)
  ...
  pg <- fread("search_results\\Unbound_MockBTX_CB\\combined\\txt\\proteinGroups.txt", check.names = TRUE)
  ...
  pdf("plots\\MockBTX_CB_log2_raw_intensities.pdf")
  ...
  pdf("plots\\ProteinGroups_MockBTX_CB_Volcano_pmod_log2FC.pdf")
  ...
  pdf("plots\\MockBTX_CB_selected_proteins.pdf", width = 6, height = 4)
  ...
  fwrite(df_sub, "SupplData03_Proteingroups_Intensities_MockBTX_CB.txt", sep = "\t")
  
  # provide figure source data
  fwrite(df_sub, "Figures\\SupplFig_4DEF\\ProteinGroups_MockBTX_CB.txt", sep = "\t")
