...
local({
  ...
  temp <- fread("Figures\\SupplFig_20\\ProteinGroups_HeLa_PhSites_Contrasts.txt", check.names = TRUE)
  ...
  # Boxplots
  pdf("Figures\\SupplFig_20\\SupplFig_20A.pdf", width = 9)
  boxplot(log2(temp[, ..int_cols]))
  dev.off()
  
  # BoNT vs Mock
  pdf("Figures\\SupplFig_20\\SupplFig_20B.pdf")
  ...
  # Mock vs UT
  pdf("Figures\\SupplFig_20\\SupplFig_20C.pdf")
  plot(y = -log10(temp$q.val),
       x = temp$log2FC,
       type = "n",
       xlab = "log2-Ratio",
  ...
  # BoNT vs UT
  pdf("Figures\\SupplFig_20\\SupplFig_20D.pdf")
  plot(y = -log10(temp$q.val),
       x = temp$log2FC,
       type = "n",
       xlab = "log2-Ratio",
