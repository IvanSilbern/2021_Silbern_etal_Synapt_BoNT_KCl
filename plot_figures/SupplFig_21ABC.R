local({
  ...
  temp <- fread("Figures\\SupplFig_21ABC\\ProteinGroups_MockBoNT_AD.txt")
  ...
  pdf("Figures\\SupplFig_21ABC\\SupplFig_21A.pdf")
  boxplot(temp[, c("Mock_01", "Mock_02", "Mock_03", "BoNT_01", "BoNT_02", "BoNT_03")])
  dev.off()
  
  pdf("Figures\\SupplFig_21ABC\\SupplFig_21B.pdf")
  ...
  pdf("Figures\\SupplFig_21ABC\\SupplFig_21C.pdf", width = 6, height = 4)
