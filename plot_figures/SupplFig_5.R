...
local({
  ...
  ph <- fread("Figures\\SupplFig_5\\Ph_events_netphorest.txt")
  ...
  pdf("Figures\\SupplFig_5\\SupplFig_5A.pdf", width = 13, heigh = 8)
  ...
  pdf("Figures\\SupplFig_5\\SupplFig_5B.pdf", width = 13, heigh = 8)
