local({
  ...
  temp <- fread("Figures\\SupplFig_21DEF\\ProteinGroups_MockBoNT_CB.txt")
  ...
  pdf("Figures\\SupplFig_21DEF\\SupplFig_21D.pdf")
  boxplot(temp[, c("Mock_01", "Mock_02", "Mock_03", "BoNT_01", "BoNT_02", "BoNT_03")])
  dev.off()
  
  pdf("Figures\\SupplFig_21DEF\\SupplFig_21E.pdf")
  ...
  pdf("Figures\\SupplFig_21DEF\\SupplFig_21F.pdf", width = 6, height = 4)
