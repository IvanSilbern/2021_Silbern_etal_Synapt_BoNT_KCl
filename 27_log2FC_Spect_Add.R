...
# OUTPUT:
# "plots\\Spectr-Add_log2FC.pdf"
# "Figures\\SupplFig_16\\log2FC_Spectr_Add.txt"
...
local({
  ...
  selected <- c("Sptb", "Sptan1", "Sptbn1", "Sptbn2", "Sptbn4", "Add1", "Add2")
  ...
  pdf("plots\\Spectr-Add_log2FC.pdf", width = 4, height = 4.8)
  print(g)
  dev.off()
  
  # save figure data
  fwrite(df, "Figures\\SupplFig_16\\log2FC_Spectr_Add.txt", sep = "\t")
