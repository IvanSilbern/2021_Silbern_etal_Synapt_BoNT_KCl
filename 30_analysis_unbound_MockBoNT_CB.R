...
# "SupplData\\SupplData02_Proteingroups_Intensities_MockBoNT_CB.txt"
# "Figures\\SupplFig_21DEF\\ProteinGroups_MockBoNT_CB.txt"

local({
  
  if(!dir.exists("SupplData")) dir.create("SupplData")
  
  if(!dir.exists("Figures\\SupplFig_21DEF")) dir.create("Figures\\SupplFig_21DEF", recursive = TRUE)
  ...
  pg <- fread("search_results\\Unbound_MockBoNT_CB\\combined\\txt\\proteinGroups.txt.gz", check.names = TRUE)
  ...
  fwrite(df_sub, "Figures\\SupplFig_21DEF\\ProteinGroups_MockBoNT_CB.txt", sep = "\t")
