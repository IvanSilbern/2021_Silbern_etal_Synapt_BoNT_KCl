...
# "Figures\\SupplFig_8\\sites_keyword_count.txt"

local({
  
  if(!dir.exists("Figures\\SupplFig_8")) dir.create("Figures\\SupplFig_8", recursive = TRUE)
  ...
  fwrite(groups_long, "Figures\\SupplFig_8\\sites_keyword_count.txt", sep = "\t")
