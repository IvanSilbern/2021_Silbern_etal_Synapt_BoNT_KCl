...
source("19_site_occupancy_calculation.R")
source("20_phosphatase_motif.R")
source("21_plot_regulated_phosphatases.R")
source("22_plot_phosphatase_graph.R")
source("23_plot_manual_annotation.R")
source("24_plot_reactome_pathway.R")
source("25_plot_log2FC_Wnt.R")
source("26_plot_log2FC_K_channels.R")
source("27_log2FC_Spect_Add.R")
source("28_report_phosphosites.R")
source("29_analysis_unbound_MockBoNT_AD.R")
source("30_analysis_unbound_MockBoNT_CB.R")
source("31_analysis_supernatant_Cbotulinum.R")
source("32_analysis_test_hela_phospho.R")
source("33_prepare_shinyapp_tables.R")
source("34_prepare_shinyapp_Rdata.R")
source("35_plot_selected_genes_svg.R")
source("36_plot_selected_genes_no_legend_svg.R")

# Uncomment to run
# Plot generation might take long!
# source("37_plot_regulated_sites_pdf.R")
# source("38_prepare_shinyapp_plots_svg.R")
...
source("plot_figures\\Fig_4D.R")
source("plot_figures\\SupplFig_2.R")
source("plot_figures\\SupplFig_3.R")
source("plot_figures\\SupplFig_4.R")
source("plot_figures\\SupplFig_7A.R")
source("plot_figures\\SupplFig_7BC.R")
source("plot_figures\\SupplFig_7DE.R")
source("plot_figures\\SupplFig_8.R")
source("plot_figures\\SupplFig_16.R")
source("plot_figures\\SupplFig_19.R")
source("plot_figures\\SupplFig_20.R")
source("plot_figures\\SupplFig_21ABC.R")
source("plot_figures\\SupplFig_21DEF.R")
