...
source("11_netphorest_group_count_fisher_test_CaEGTA_MockBTX.R")
source("12_GOBP_netphorest_group_enrichm.R")
source("13_comparison_MockBTX_CaEGTA.R")
...
source("20_analysis_unbound_MockBTX_AD.R")
source("21_analysis_unbound_MockBTX_CB.R")
source("22_analysis_supernatant_Cbotulinum.R")
source("23_analysis_test_hela_phospho.R")
source("24_prepare_tables_shiny_app.R")
...
source("plot_figures\\SupplFig_4ABC.R")
source("plot_figures\\SupplFig_4DEF.R")
source("plot_figures\\SupplFig_5.R")
source("plot_figures\\SupplFig_4DEF.R")
source("plot_figures\\SupplFig_6.R")