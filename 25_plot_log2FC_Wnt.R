...
# OUTPUT:
# "plots\\Wnt_log2FC.pdf"
# "Figures\\SupplFig_16\\log2FC_Wnt.txt"
...
local({
  ...
  selected <- prot_class[grepl("[Ww]nt", Keyword_manual)]$Gene.name
  ...
  pdf("plots\\Wnt_log2FC.pdf", width = 4, height = 10)
  print(g)
  dev.off()
  
  # save figure data
  fwrite(df, "Figures\\SupplFig_16\\log2FC_Wnt.txt", sep = "\t")
