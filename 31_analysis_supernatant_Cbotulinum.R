...
# "Figures\\SupplFig_19\\Proteingroup_Intensity_Suprenatants_Cbotulinum.txt"


local({

  if(!dir.exists("Figures\\SupplFig_19\\")) dir.create("Figures\\SupplFig_19\\", recursive = TRUE)
  ...
  # provide source data
  fwrite(df_long, "Figures\\SupplFig_19\\Proteingroup_Intensity_Suprenatants_Cbotulinum.txt", sep = "\t")
